  ...
  return (
    <div className="profile-left-header flex justify-between items-center">
      ...
      <div className="profile-right flex">
        ...
        {isUser && (
          <button className="delete-button flex items-center text-delete-color font-bold hover:underline mr-4">
            <svg className="mr-3" width="12" height="14" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        {isUser ? (
          ...
          >
            <svg className="mr-3" width="14" height="14" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <button
            ...
            onClick={onReplyClick}
          >
            <svg className="mr-3" width="14" height="13" xmlns="http://www.w3.org/2000/svg">
              <path
